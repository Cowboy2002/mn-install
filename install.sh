...
CONFIG_FILE='blockshare.conf'
CONFIGFOLDER='/root/.blockshare'
COIN_DAEMON='/usr/local/bin/blockshared'
COIN_CLI='/usr/local/bin/blockshare-cli'
COIN_REPO='https://github.com/Eustass-Shanks/Blockshare-core/releases/download/v1.0.0/blockshare-v1.0.0-x86_64-linux-gnu.tar.xz'
COIN_NAME='Blockshare'
COIN_PORT=61612
